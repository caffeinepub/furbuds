  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        teal: { DEFAULT: "oklch(var(--brand-teal))", dark: "oklch(var(--brand-teal-dark))" },
        coral: { DEFAULT: "oklch(var(--brand-coral))" },
        cream: { DEFAULT: "oklch(var(--brand-cream))" },
        sage: { DEFAULT: "oklch(var(--brand-sage))" },
      },
      borderRadius: { lg: "var(--radius)", md: "calc(var(--radius) - 2px)", sm: "calc(var(--radius) - 4px)" },
      boxShadow: { xs: "0 1px 2px 0 rgba(0,0,0,0.05)", card: "0 4px 20px rgba(0,0,0,0.08)" },
      keyframes: {
